...
function appetizersTmpl(data) {
    var isSpicy;
    var spicy = `<span class="entypo-flash"><div class="popupSpicy">
  <span class="popupTitle">Spicy</span>
  <span class="popupContent">This item is spicy, please handle with care and drink lots of water.</span></div></span>`;
    var notSpicy = "";
    if (data.spicy === 1) {
        isSpicy = spicy;
    } else {
    ...
    var isFavorite;
    var favorite = `<span class="entypo-star"><div class="popupFav">
  <span class="popupTitle">Restaurant Favorite</span>
  <span class="popupContent">We have been doing this a long time and this item has become one of our favorites.</span></div></span>`;
    var notFavorite = "";
    if (data.favorite === 1) {
        isFavorite = favorite;
    } else {
    ...
    var isAllergic;
    var allergies = `<span class="entypo-alert"><div class="popupAllergy">
  <span class="popupTitle">Allergy Info</span>
  <span class="popupContent">This item may contain shellfish or another item that some people may be allergic to. Please ask your waiter or waitress for assistance.</span></div></span>`;
    var notAllergic = "";
    if (data.allergies === 1) {
    ...
    var isVegan;
    var vegan = `<span class="entypo-vimeo-circled"><div class="popupVegan">
  <span class="popupTitle">Vegan</span>
  <span class="popupContent">This item contains no meat and has been prepared without the use of animal products.</span></div></span>`;
    var notVegan = "";
    if (data.vegan === 1) {
        isVegan = vegan;
    } else {
  ...
  ${isAllergic}${isFavorite}${isSpicy}${isVegan}
  </div></div></div>`;
